...
**Update:** There is [rc version 1.0.0-rc.2 for Meteor 1.3-rc.2](https://github.com/juliancwirko/meteor-postcss/tree/meteor-1.3-in-progress) it is also published on Atmosphere.
